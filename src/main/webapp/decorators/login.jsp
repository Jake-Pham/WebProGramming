...
<link
	...
	rel="stylesheet">
<link
	href="<c:url value="/templates/assets/global/plugins/carousel-owl-carousel/owl-carousel/owl.carousel.css" />"
	rel="stylesheet">
<link
	href="<c:url value="/templates/assets/global/plugins/slider-layer-slider/css/layerslider.css" />"
	rel="stylesheet">
...
<link
	...
	rel="stylesheet">
<link
	href="<c:url value="/templates/assets/frontend/layout/css/style.css" />"
	rel="stylesheet">
<link
	href="<c:url value="/templates/assets/frontend/pages/css/style-shop.css" />"
	rel="stylesheet" type="text/css">
<link
	href="<c:url value="/templates/assets/frontend/pages/css/style-layer-slider.css" />"
	rel="stylesheet">
<link
	href="<c:url value="/templates/assets/frontend/layout/css/style-responsive.css" />"
	rel="stylesheet">
<link
	href="<c:url value="/templates/assets/frontend/layout/css/themes/red.css" />"
	rel="stylesheet" id="style-color">
<link
	href="<c:url value="/templates/assets/frontend/layout/css/custom.css" />"
	rel="stylesheet">
<!-- Theme styles END -->
</head>
<!-- Head END -->
...
<body class="ecommerce">
	...
	<script
		...
		type="text/javascript"></script>
	<script
		src="<c:url value="/templates/assets/frontend/layout/scripts/back-to-top.js" />"
		type="text/javascript"></script>
	<script
	...
	<!-- pop up -->
	<script
		src="<c:url value="/templates/assets/global/plugins/carousel-owl-carousel/owl-carousel/owl.carousel.min.js" />"
		type="text/javascript"></script>
	<!-- slider for products -->
	<script
		src="<c:url value="/templates/assets/global/plugins/zoom/jquery.zoom.min.js" />"
		type="text/javascript"></script>
	<!-- product zoom -->
	<script
	...
	<!-- BEGIN LayerSlider -->
	<script
		src="<c:url value="/templates/assets/global/plugins/slider-layer-slider/js/greensock.js" />"
		type="text/javascript"></script>
	<!-- External libraries: GreenSock -->
	<script
		src="<c:url value="/templates/assets/global/plugins/slider-layer-slider/js/layerslider.transitions.js" />"
		type="text/javascript"></script>
	<!-- LayerSlider script files -->
	<script
		src="<c:url value="/templates/assets/global/plugins/slider-layer-slider/js/layerslider.kreaturamedia.jquery.js" />"
		type="text/javascript"></script>
	<!-- LayerSlider script files -->
	<script
		src="<c:url value="/templates/assets/frontend/pages/scripts/layerslider-init.js" />"
		type="text/javascript"></script>
	<!-- END LayerSlider -->

	<script
		src="<c:url value="/templates/assets/frontend/layout/scripts/layout.js" />"
		type="text/javascript"></script>
